...
# Debian / Ubuntu — grab aegis_<version>_<arch>.deb from the latest release (v1.1.0), then:
sudo apt install ./aegis_1.1.0_amd64.deb      # installs aegis + the harness under /usr/lib/aegis

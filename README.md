...
# Debian / Ubuntu — grab aegis_<version>_<arch>.deb from the latest release (v1.6.0), then:
sudo apt install ./aegis_1.6.0_amd64.deb      # installs aegis + the harness under /usr/lib/aegis

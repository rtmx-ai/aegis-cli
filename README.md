...
# Debian / Ubuntu — grab aegis_<version>_<arch>.deb from the latest release (v1.3.1), then:
sudo apt install ./aegis_1.3.1_amd64.deb      # installs aegis + the harness under /usr/lib/aegis
